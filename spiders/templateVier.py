...
# -*- encoding: utf-8 -*-
'''
@File    :   templateVier.py
@Time    :   2019/12/09 17:32:32
@Author  :   Hzx 
@Version :   1.0
@Contact :   hzxstarcloud@hotmail.com
@Desc    :   主要考虑start_url需要换成start_request方法
@memo    :   post方法---rym
'''
...
from ..items import *
from ..urls import get_start_requests_params
...
class TemplatevierSpider(CrawlSpider):

    '''version 4.0
    mainly for start_requests
    ...
    def __init__(self,*args,**kwargs):
        ...
        9.[self]starturl&formdata_li_dic:
        ...
        if start_request_params:
            ...
            Kwargs = start_request_params.get("Kwargs",{})
            # start_request下的p_type  针对post  json
            ...
            self.start_urls = []
            self.form_list_dic = {}
        self.logger.debug(r"<<<<<<< [start information]:%s \n %s" % (self.start_urls,self.form_list_dic))
        self.logger.info("START_URLS&FORM_LIST INIT Success!")
        ...
        # for _compile_rules
        super(TemplatevierSpider, self).__init__(*args,**kwargs)
