...
class wzbSpider(TemplatedreiSpider):
    name = 'wzb'
    custom_settings = {
        "USER_AGENT": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36",
        "ITEM_PIPELINES": {
...
class iwepSpider(TemplatedreiSpider):
    name = 'iwep'
    custom_settings = {
        "USER_AGENT": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36",
        "ITEM_PIPELINES": {
...
class azjaSpider(TemplatedreiSpider):
    name = 'azja'
    custom_settings = {
        "USER_AGENT": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36",
        "ITEM_PIPELINES": {
...
class oswSpider(TemplatedreiSpider):
    name = 'osw'
    custom_settings = {
        "USER_AGENT": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36",
        "ITEM_PIPELINES": {
...
class bruegelSpider(TemplatedreiSpider):
    name = 'bruegel'
    custom_settings = {
        "USER_AGENT": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36",
        "ITEM_PIPELINES": {
...
class weforumSpider(TemplatedreiSpider):
    name = 'weforum'
    custom_settings = {
        "USER_AGENT": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36",
        "ITEM_PIPELINES": {
...
class martensSpider(TemplatedreiSpider):
    name = 'martens'
    custom_settings = {
        "USER_AGENT": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36",
        "ITEM_PIPELINES": {
...
class tandfonlineSpider(TemplatedreiSpider):
    name = 'tandfonline'
    custom_settings = {
        "USER_AGENT": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36",
        "ITEM_PIPELINES": {
...
class capSpider(TemplatevierSpider):
    name = "cap"
    custom_settings = {
        "USER_AGENT": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36",
        "ITEM_PIPELINES": {
...
class wiiwSpider(TemplatevierSpider):
    name = "wiiw"
    custom_settings = {
        "USER_AGENT": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36",
        "ITEM_PIPELINES": {
